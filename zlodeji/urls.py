...
urlpatterns = [
    ...
    re_path(r'dostal/add/$', views.DostalCreate.as_view(), name='dostal-add'),
    re_path(r'povolenie/add/$', views.PovolenieCreate.as_view(), name='povolenie-add'),
    re_path(r'lupeznik/add/$', views.VydriduchCreate.as_view(), name='vydriduch-add'),
    re_path(r'vydriduch/add/$', views.LupeznikCreate.as_view(), name='lupeznik-add'),
    re_path(r'vlastnil/add/$', views.VlastnilCreate.as_view(), name='vlastnil-add'),
    re_path(r'vlastnilzlodej/add$', views.VlastnilCreatezlodej.as_view(), name='vlastnil-addzlodej'),
    re_path(r'skolenie/add/$', views.SkolenieCreate.as_view(), name='skolenie-add'),
    re_path(r'skolenieZ/add/$', views.SkolenieZlocinuCreate.as_view(), name='skoleniezlocinu-add'),
    re_path(r'skolenieV/add/$', views.SkolenieVybaveniaCreate.as_view(), name='skolenievybavenia-add'),
    ...
    re_path(r'dostal/(?P<pk>[0-9]+)/delete/$', views.DostalDelete.as_view(), name='dostal-delete'),
    re_path(r'eviduje/(?P<pk>[0-9]+)/delete/$', views.EvidujeDelete.as_view(), name='eviduje-delete'),
    re_path(r'vlastnil/(?P<pk>[0-9]+)/delete/$', views.VlastnilDelete.as_view(), name='vlastnil-delete'),
